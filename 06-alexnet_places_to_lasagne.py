...
def load_caffe():
    ...
    m = caffe.io.caffe_pb2.BlobProto.FromString('/imatge/jpan/lsun2016/saliency-2016-lsun/cnn_models/places/places205CNN_mean.binaryproto')
    mean  = caffe.io.blobproto_to_array(m)[0]
    ...
    pickle.dump(values, open('caffe_places.pkl', 'w'),protocol=pickle.HIGHEST_PROTOCOL)
